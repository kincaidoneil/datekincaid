              ...
              <section>
                ...
                <section className="flex flex-col gap-4">
                  ...
                  <FloatIntoView.Group className="grid grid-cols-2 gap-4">
                    <FloatIntoView.Item className="aspect-3/4">
                      <LightboxImage
                ...
                <section>
                  <FloatIntoView.Group className="grid grid-cols-2 grid-rows-[repeat(2,min-content)] gap-4">
                    <FloatIntoView.Item>
                      <LightboxImage
                        src={Fam.src}
                    ...
                    <FloatIntoView.Item className="col-span-full">
                      <LightboxImage
                        src={Melon.src}
